...
async def upload_document(
    ...
    try:
        ...
        os.makedirs(env_settings.upload_dir, exist_ok=True)
        ...
        env_settings = get_settings()
        file_path = os.path.join(env_settings.upload_dir, filename)
...
async def test_ocr():
    ...
    try:
        ...
        return {
            ...
            "upload_dir_exists": os.path.exists(get_settings().upload_dir)
        }
    except Exception as e:
        return {
            "error": str(e),
